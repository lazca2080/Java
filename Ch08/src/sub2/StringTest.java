...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 비교
		if(str1 == str2) { // 주소 비교 상태, 문자열 비교는 equals
		...
		System.out.println("sample 7에서 마지막까지자르기 : " + sample.substring(6));
		
		// 문자열 인덱스
		System.out.println("sample 앞에서부터 문자 e 인덱스 : " + sample.indexOf("e"));
		System.out.println("sample 뒤에서부터 문자 e 인덱스 : " + sample.lastIndexOf("e"));
		...
		String s1 = String.valueOf(var1); //static 메서드
